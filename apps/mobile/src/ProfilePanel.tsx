...
export function ProfilePanel({
  ...
  styles: { body: StyleProp<ViewStyle>; title: StyleProp<TextStyle>; bodyText: StyleProp<TextStyle>; link: StyleProp<TextStyle>; caveat: StyleProp<TextStyle>; error: StyleProp<TextStyle> };
  ...
  return (
    <ScrollView style={styles.body} accessibilityLabel="Settings">
      ...
      <Text style={styles.bodyText}>Account and research privacy. Purchases and push notifications are currently unavailable.</Text>
