...
it.each([{count:129,size:100,reason:"invalid_extraction_selection"},{count:25,size:11000,reason:"model_context_too_large"}])("W02 rejects $count passages / $size characters before extraction issuance",async({count,size,reason})=>{
