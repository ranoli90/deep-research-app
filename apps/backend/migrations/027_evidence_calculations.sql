CREATE TABLE IF NOT EXISTS evidence_calculations (
 id uuid PRIMARY KEY,
 ...
 UNIQUE(run_id,extraction_intent_id,support_intent_id,calculator_version,input_digest)
);
CREATE INDEX IF NOT EXISTS evidence_calculations_owner ON evidence_calculations(account_id,run_id);
