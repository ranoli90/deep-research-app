...
export const ExtractedDocument = z.object({
  version: z.enum(["trafilatura-2.2.0/structure-v2", "trafilatura-2.2.0/structure-v1", "pypdf-6.19.0/digital-v1", "docling-parse-7.20.0/geometry-v1", "utf8-notes-v1", "unavailable-v1"]), digest: z.string().regex(/^[a-f0-9]{64}$/),
