...
|---|---|---|
| P0-D local Postgres/queue + twelve smoke + fencing | implemented and verified | `pnpm test:integration` 99/99 including R02 continue-without-geography reject; postgres:16.10-alpine on 55432; pg-boss 10.0.4 |
