...
Local branch `codex/v8-recovery-20260920` remains based on refreshed `origin/grok-v8/research-beta-integration` `bb80cfd2d2a3b14e224e516b165871fc60e58105`. Preservation head `4ba21a6` retains the exact independent BB-01/02/03 suites; rejected integrated head `19a0bd38` and every rejected repair remain in ancestry. The follow-ons were imported once: RES-02 `2cc678f` then approved `187a2f0`; RES-04 `1b7640a`/rejected evidence `a7b6d52` then approved `62a374c`/evidence `6a03137`; W08 `cfe382b` then approved `5e76f51`/evidence `e61c655`. Patch-equivalent b818/55ea/3116 bases were not replayed.
