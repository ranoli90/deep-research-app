...
| P0-N Android | implemented and verified on device (cancel-during-writing via API launch-check) | Xiaomi `25098RA98G`; attach, share, 120 EUR Vendor C, Flag submitted `9806c317` on report `6bb62a2f`; TalkBack M02 labels captured then disabled; compact keyboard keeps Send |
...
3. Remaining M04 long-content/wide-table and M11 purchase sandbox when a store sandbox exists.
