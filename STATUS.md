...
|---|---|---|
| P0-D local Postgres/queue + twelve smoke + fencing | implemented and verified | `pnpm test:integration` 95/95 including G07/M10 output reporting; postgres:16.10-alpine on 55432; pg-boss 10.0.4 |
