...
| P0-N Android | implemented and verified on device (cancel-during-writing via API launch-check) | Xiaomi `25098RA98G`; attach `99391a32`; share sheet; 120 EUR correction `cbc04309` shows Vendor C; previous version retained |
...
2. TalkBack on the Xiaomi; Flag/Verify native taps if still needed.
