...
|---|---|---|
| P0-D local Postgres/queue + twelve smoke + fencing | implemented and verified | `pnpm test:integration` 102/102 including JOB-1 Linux drop; postgres:16.10-alpine on 55432; pg-boss 10.0.4 |
