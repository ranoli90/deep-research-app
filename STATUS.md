...
|---|---|---|
| P0-D local Postgres/queue + twelve smoke + fencing | implemented and verified | `pnpm test:integration` 90/90 including G01/G02 and P4 recovery; postgres:16.10-alpine on 55432; pg-boss 10.0.4 |
...
4. Remaining unblocked P4: operating-cost measurement on fixture (no extra OpenRouter), or other non-gated acceptance IDs. Do not mark G03–G07 as passed.
