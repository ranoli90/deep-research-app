...
- Rollback: revert `1b7640a`, then `045076c`, then `9327b21`, while retaining strict readers and held records. No schema, dependency, stored-row rewrite, financial state, or remote state changed.
