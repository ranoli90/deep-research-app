...
W02/W03 cancellation follow-on: three PostgreSQL defects reproduced and fixed with atomic owned cancellation/event writes;5new controls and81affected integration tests pass, backend types/boundaries pass. Artifacts verification/v6/cancellation-atomicity/RESULTS.json retain pre-fix failures. No new dependencies/migrations/live spend. Source is a follow-on to eb133e8 pending checkpoint commit.
