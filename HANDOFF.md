...
Working tree: `main` at `a76983a5a914c366718c9eb7dae876de2955b2dd`. P0 is **not** fully verified: iOS P0-N is blocked.
...
| `pnpm --filter @deep/mobile test` | 0 | 30 tests including M05 offline error mapping |
