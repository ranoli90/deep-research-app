...
Next executable work: real binary documents and remaining identity lifecycle. Then finish real binary documents, strict typed actions/general model gateway, criterion-linked completion, real correction reuse and held-out API/worker evaluation. Do not use the green fixture suite as evidence that these exist. Do not restore permissive publication behavior to preserve prose.
