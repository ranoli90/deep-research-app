...
Active production/tests match approved RES-02 `187a2f0` and RES-04 `62a374c`; W08 helper/tests match `5e76f51`. The mobile screen-state spec deliberately unions the final RES-04 all-journal state gate with the already-approved RES-01 child-lease transfer. RES-02 retains compound entity×fact Evidence Needs, v2/v3/v4 immutable replay and alias suppression without collapsing genuine overlapping names. RES-04 retains strict binders, same-parent confirmation, terminal-record validation and damaged-sibling admission blocking. W08 retains exact token boundaries and executable-helper provenance.
