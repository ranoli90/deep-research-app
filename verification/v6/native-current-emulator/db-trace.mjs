...
const owner='60888c19-ca97-44fb-8d65-4975921a50f6';
const queries={
...
try{
 ...
 const path=process.argv[2]; if(!/^verification\/v6\/native-current-emulator\/[a-z-]+\.json$/.test(path??''))throw Error('Expected bounded evidence path');
